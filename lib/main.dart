  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        // --- Repositories ---
        Provider<IUserRepository>( // Usando a interface, se disponível
          create: (context) => UserRepository(
            firebaseAuth: context.read<FirebaseAuth>(),
            dbRef: context.read<DatabaseReference>(), // Realtime Database
            storage: context.read<FirebaseStorage>(),
            // Se você usa Firestore no UserRepository também, adicione:
